  ...
  private curatedCatalog: MovieDetails[] = [
    {
      ...
      cast: [
        ...
        { id: 1373737, name: 'Austin Butler', character: 'Feyd-Rautha Harkonnen', profileUrl: null }
      ],
      recommendations: [],
      similar: []
    },
    ...
    },
    {
      ...
      status: 'Released',
      cast: [
        { id: 6384, name: 'Keanu Reeves', character: 'Neo', profileUrl: null },
        { id: 2975, name: 'Laurence Fishburne', character: 'Morpheus', profileUrl: null }
      ],
      recommendations: [],
      similar: []
    },
