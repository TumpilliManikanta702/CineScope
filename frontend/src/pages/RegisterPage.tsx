...
import { Film, User as UserIcon, Mail, Lock, Loader2 } from 'lucide-react';
...
export const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (registerUser.fulfilled.match(action)) {
      dispatch(addToast({ message: 'Welcome to CineScope! Your account is ready.', type: 'success' }));
    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.6rem', fontWeight: 800 }}>Join CineScope</h1>
          <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', marginTop: '0.35rem' }}>
            Curate, discover, and organize your favorite cinema
          </p>
        </div>
